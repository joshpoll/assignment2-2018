...
def make_matrix_softmax(shape, tgt, tgt_host, func_name, dtype="float32"):
    ...
    OUT = tvm.compute(shape, lambda i, j: E_X(i, j) / SUM(i))
...
def make_matrix_softmax_cross_entropy(shape, tgt, tgt_host, func_name,
    ...
    # TODO: should take advantage of existing softmax implementation
    X = tvm.placeholder(shape, dtype=dtype, name="X")
    ...
    SUM2 = tvm.compute((1,), lambda i: tvm.sum(SUM1(i), axis=k2), name="SUM2")

    OUT = tvm.compute((1,), lambda *i: -SUM1(*i) / SUM2(0))
